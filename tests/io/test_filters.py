...
def test_agent_filters(api):
    '''
    test to check the agent filters and their types
    '''
...
def test_workbench_asset_filters(api):
    '''
    test to check the workbench asset filters and their types
    '''
...
def test_scan_filters(api):
    '''
    test to check the scan filters and their types
    '''
...
def test_access_group_asset_rules_filters(api):
    '''
    test to check the access group asset rules filter and their types
    '''
...
def test_access_group_filters(api):
    '''
    test to check the access gropu filters and their types
    '''
...
@pytest.mark.vcr()
def test_filters_credentials_true_filters(api):
    '''
        test to raise the exception when the credentials filter is normalized
    ...
    for data in filters:
        check(filters[data], 'operators', list, allow_none=True)
        check(filters[data], 'pattern', str, allow_none=True)
